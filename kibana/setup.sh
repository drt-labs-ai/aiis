...
echo "  AIIS — A2A & Supervisor : ${KIBANA_URL}/app/dashboards#/view/aiis-a2a-payload-dashboard"
echo "  AIIS — MCP Tool Payloads: ${KIBANA_URL}/app/dashboards#/view/aiis-mcp-payload-dashboard"
echo "  AIIS — RAG Payloads     : ${KIBANA_URL}/app/dashboards#/view/aiis-rag-payload-dashboard"
echo ""
